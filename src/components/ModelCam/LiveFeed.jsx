...
function LiveFeed({videoRef,play,playing,setIsplaying}) {

  const palyLiveFeed = async () => {
    let result = await play()
    if(result.status) {
      setIsplaying(true)
    }else {
      if(result.error.message == 'Error: Room Not Found') {
        alert("Model is not online")
      }
            ...
            <div className="content">
              <div className="mse-player">
                <div className="video-element-wrapper">
                  ...
                  {!playing && <div onClick={palyLiveFeed} className="play-button">
                    Play
                    <svg className="icon icon-play-3">
                      <use xlinkHref="#icons-play-3" />
                    </svg>
                  </div>}
                </div>
              </div>
              ...
              <div className="player-controls-layers player-controls-user player__player-controls">
                ...
                <div className="player-controls-layers__layer player-controls-layers__layer--permanent-controls"><button className="btn ds-btn-inline-block player-controls-user__join-btn player-join-button" type="button">Join Me for Free</button></div>
              </div>
            </div>
          </div>
        </div>
                            ...
                            <div className="CollapsedV2#B0 CollapsedV2_clickAll#Du CollapsedV2_closed#r2 PWANotificationTooltipQrCode#Xr notifications-tooltip-content__pwa undefined">
                              <div className="CollapsedV2__header#eU PWANotificationTooltipQrCode__headerWrapper#zh">
                                <div className="PWANotificationTooltipQrCode__header#oh">
                                  <div className="PWANotificationTooltipQrCode__logo#Ge pwa-logo pwa-logo--white"><img className="pwa-logo__wl" src="https://assets.strpst.com/assets/icons/appicon_stripchat.global.png?v=28b983cf" alt="Stripchat Global" /></div>
                                  <div>
            ...
            <div className="epic-goal-progress__wrap epic-goal-progress__wrap--view-cam">
              ...
              <div className="epic-goal-progress__content">
                ...
                <div className="epic-goal-progress epic-goal-progress--view-cam">
                  ...
                  <div className="epic-goal-progress__status epic-goal-progress__status--view-cam">
                    0.3{/* */}%
                  </div>
                </div>
              </div>
            </div>
            <h2 className="media-up-to-xs-hidden view-cam-info-goal__title view-cam-info-topic"><span>. </span><span>​</span><span>Insta: </span><span>​</span><span>June</span><span>​</span><span>695_ ♥️ </span><span>​</span><span>Tg: </span><span>​</span><span>Jjune</span><span>​</span><span>695</span><span>​</span></h2>
          </div>
